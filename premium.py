...
def revan_129():
    time.sleep(0.1)
    print("\033[97m [\033[96m01\033[97m] Mulai swiper dari ID")
    ...
    if revan == "1" or revan =="01":
         ...
         def fromlikes(url):
             try:
                  ...
                  exit(" \033[1;97m [\033[1;94m•\033[1;97m] Tautan postingan harus publik!")
         def getlike(react):
         ...
         if __name__ == '__main__':
               try:
                   ...
                   ikeh_ikeh_kimochi()
                   kontol()
                   aahh('\033[1;97m [\033[1;92m01\033[1;97m] Swiper pertemanan')
                   aahh('\033[1;97m [\033[1;92m02\033[1;97m] Swiper dari postingan publik')
                   aahh('\033[1;97m [\033[1;92m03\033[1;97m] Swiper dari ID pencarian nama')
                   aahh('\033[1;97m [\033[1;92m04\033[1;97m] Swiper dari ID grup ')
                   aahh('\033[1;97m [\033[1;92m05\033[1;97m] Swiper dari ID pertemanan publik ')
                   aahh('\033[1;97m [\033[1;92m06\033[1;97m] Lihat pedapatan akun')
                   ...
                   if memek =="":
                         ...
                         os.system('xdg-open https://www.facebook.com/1836274989')
                         exit()                   	
